   ...
   4392 22 2D 4C      [16]   82 	ld	(_callback_counter), hl
   4395 C9            [10]   83 	ret
   ...
   43B1 2A 2D 4C      [16]  124 	ld	hl, (_callback_counter)
   ...
   43BF 22 2D 4C      [16]  132 	ld	(_callback_counter), hl
                            133 ;src/jdvapi_sync.c:77: aFunction(callback_counter);
   43C2 21 2D 4C      [10]  134 	ld	hl,#_callback_counter + 0
   43C5 46            [ 7]  135 	ld	b, (hl)
   43C6 C5            [11]  136 	push	bc
   43C7 33            [ 6]  137 	inc	sp
   43C8 2A 2F 4C      [16]  138 	ld	hl, (_aFunction)
   ...
   43F4 32 2F 4C      [13]  179 	ld	(#_aFunction + 0),a
   43F7 21 03 00      [10]  180 	ld	hl, #2+1
   43FA 39            [11]  181 	add	hl, sp
   43FB 7E            [ 7]  182 	ld	a, (hl)
   43FC 32 30 4C      [13]  183 	ld	(#_aFunction + 1),a
   43FF C9            [10]  184 	ret
   ...
   4C35                     339 __xinit__callback_counter:
   4C35 00 00               340 	.dw #0x0000
   4C37                     341 __xinit__aFunction:
   4C37 9F 43               342 	.dw _callback
                            343 	.area _CABS (ABS)
