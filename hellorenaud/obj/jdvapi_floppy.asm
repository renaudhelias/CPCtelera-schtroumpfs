...
;--------------------------------------------------------
	.area _CODE
;src/jdvapi_floppy.c:19: void SetupDOS()
;	---------------------------------
; Function SetupDOS
; ---------------------------------
_SetupDOS::
;src/jdvapi_floppy.c:52: __endasm;
...
;;	This will restore the drive number to the drive the loader was run from
	...
	push	hl
	ret
;src/jdvapi_floppy.c:62: void LoadFile(char *sFileName, char *pLoadAddress)
;	---------------------------------
; Function LoadFile
; ---------------------------------
_LoadFile::
;src/jdvapi_floppy.c:64: nFileNameLen = strlen(sFileName);
	pop	bc
	pop	hl
	push	hl
	push	bc
	...
	ld	iy, #_nFileNameLen
	ld	0 (iy), l
;src/jdvapi_floppy.c:96: __endasm;
